...
<!--{assign var="createProMantis" value="$managerURL?doAction=createProMantis&amp;projectID="}-->
...
{else}
	<table id="item_view" class="simple_tableruler sortable">
		<tr>
			...
			{/if}
                        <th class="icon_cell">Criar Projeto MantisBT</th>
		</tr>
		...
		<tr>
			...
			{/if}
                        <td >
                            <a href="javascript:create_project_mantisBT({$testproject.id})">
                                Criar</a>
