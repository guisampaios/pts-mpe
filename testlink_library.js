...
{
    window.open("http://localhost/mantisbt/integracao/createProjectMantis.php?tproject_id="+tproject_id,"create_project_mantisBT","width=870,height=650,resizable=yes,dependent=yes");
}
function bug_dialog()
{
	this.refWindow = null;
